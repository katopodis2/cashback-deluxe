<div class="buttons_section">
    <div class="container">
        <button id="view" data-toggle="modal" data-target="#exampleModalCenter" ><i class="far fa-play-circle"></i> {{__("global.watch_video")}}</button>
        ...
        <a href="{{route('register')}}" style="color: white; text-decoration: none;"><button id="register">{{__("global.register_now")}}</button></a>
        <br clear="all">
    </div>
</div>
